...
def read(filenames, batch_size):
    ...
    with tf.Session() as sess:  
        ...
        e_val, l_val, in_val, out_val = sess.run([features, features_1, in_put_f, out_put_f])
...
def get_info_form_file_and_slice(filenames, begin, size, diff_size):
    ...
    label_batch = tf.slice(label_batch_old, [begin, 0], [size, 6])
...
#300188 过滤第一个
begin = lines_000001 - lines_300188
